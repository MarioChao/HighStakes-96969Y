...
void autonpaths::runAutonRedDown() {
	...
	driveAndTurnDistanceTiles(-2.10, -170.0, 60.0, 50.0, defaultMoveTilesErrorRange, 2.0);
	turnToAngle(-60.0);
	setIntakeState(0);
	driveAndTurnDistanceTiles(0.5, -60.0, 60.0, 100.0, defaultMoveTilesErrorRange, 1.0);
	setArmHangState(0);
	task::sleep(100);
