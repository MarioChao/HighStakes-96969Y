...
void doAuton() {
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1_tiles), 2.2_tiles, 0_tiles, false, 25), true);
	wait(0.3, sec);
	setArmStage(3);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1_tiles), 2.2_tiles, 0_tiles, false, 10), true);
	wait(0.3, sec);
