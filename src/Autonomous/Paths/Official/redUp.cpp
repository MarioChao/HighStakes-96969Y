...
void doAuton() {
	...
	setIntakeState(1);
	waitUntil(global::_driveToPointDistanceError.tiles() < 1.5);
	...
	if (configs::willTouchLadder()) {
		...
		// Back up
		wait(0.5, sec);
		global::driveToPoint(robotChassis, global::driveToPoint_params(1_tiles, 3.5_tiles, 0, true), true);
		waitUntil(global::_driveToPointDistanceError.tiles() < 0.2);
		// Go to positive corner
		waitUntil(_autonTimer.time(sec) > 13.5);
		global::driveToPoint(robotChassis, global::driveToPoint_params(0.5_tiles, 2_tiles, 0, false, 60), true);
		waitUntil(global::_driveToPointDistanceError.tiles() < 0.4);
		global::driveToPoint(robotChassis, global::driveToPoint_params(0.5_tiles, 1.5_tiles, 0, false, 60), false);
	}
}
