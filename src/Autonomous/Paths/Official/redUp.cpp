...
void doAuton() {
	...
	waitUntil(global::_driveToPointDistanceError < 0.2);
	global::driveToPoint(robotChassis, global::driveToPoint_params(2.52_tiles, 6_tiles, 0.4_tiles, false, 100, 1.5), true);
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(2_tiles, 5.5_tiles, 0.5_tiles), true);
	waitUntil(global::_driveToPointDistanceError < 0.4);
	// Corner ring 1
	setArmStage(6);
	global::driveToPoint(robotChassis, global::driveToPoint_params(0.5_tiles, 5_tiles), true);
	waitUntil(global::_driveToPointDistanceError < 0.5);
	global::driveToPoint(robotChassis, global::driveToPoint_params(0_tiles, 6_tiles, 0, false, 30, 1.5), false);
	// Middle ring
