...
void doAuton() {
	...
	waitUntil(global::_linearPathDistanceError < 0.3);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - 0_tiles, 6_tiles, false, 50), false);
	...
	setArmStage(5);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - 1.8_tiles, 3_tiles, false, 50), true);
