...
void doAuton() {
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (2_tiles), 4_tiles, 0_tiles, true, 30), true);
	...
	// Top ring
	setIntakeState(1);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (3_tiles), 5_tiles, 0.5_tiles), true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (2.7_tiles), 6_tiles, 0.4_tiles, false, 60, 1.5), true);
	...
	waitUntil(global::_driveToPointDistanceError < 0.2);
	// (2, 5) ring
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1.9_tiles), 4.9_tiles), true);
	setIntakeStoreRing(true);
	waitUntil(global::_driveToPointAngleError_degrees < 40.0);
	setIntakeStoreRing(false);
	waitUntil(global::_driveToPointAngleError_degrees < 20.0);
	setIntakeState(1);
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (0_tiles), 6_tiles, 0, false, 40, 1.0), false);
	wait(0.3, sec);
	// Middle ring
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (0.9_tiles), 5_tiles, 0, true), true);
	setIntakeStoreRing(true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (0.9_tiles), 3_tiles, 0, false, 60), true);
	setArmStage(3);
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1_tiles), 3_tiles, 0, false, 40), true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
	setIntakeLiftState(false);
	// Back up
	wait(0.5, sec);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1.8_tiles), 4.2_tiles, 0, true), true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
	// Ladder
