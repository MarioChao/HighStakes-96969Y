...
void doAuton() {
	...
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (2.76_tiles), 5.8_tiles, 0.4_tiles), true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
	// (2, 5) ring
	...
	waitUntil(global::_driveToPointDistanceError < 0.4);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1_tiles), 3_tiles), true);
	waitUntil(global::_driveToPointDistanceError < 1.2);
	setIntakeLiftState(true);
	waitUntil(global::_driveToPointDistanceError < 0.7);
	global::driveToPoint(robotChassis, global::driveToPoint_params(6_tiles - (1_tiles), 3_tiles, 0, false, 40.0), true);
	waitUntil(global::_driveToPointDistanceError < 0.2);
