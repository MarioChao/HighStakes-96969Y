...
namespace {
    ...
    void runAutonRedDown() {
        ...
        driveAndTurnDistanceTiles(-0.7, -122.0, 30.0, 100.0, autonvals::defaultMoveTilesErrorRange, 3.0);
        ...
        driveAndTurnDistanceTiles(0.6, -55, 20.0, 100.0);
    ...
    void runAutonBlueUp() {
        ...
        driveAndTurnDistanceTiles(-0.2, 90.0, 20.0, 100.0, autonvals::defaultMoveTilesErrorRange, 1.5);
        ...
        turnToAngle(-55.0);
        setIntakeState(1);
        driveAndTurnDistanceTiles(1.0, -55.0, 40.0, 100.0, autonvals::defaultMoveTilesErrorRange, 1.5);
        task::sleep(500);
        driveAndTurnDistanceTiles(-0.1, -55.0, 40.0, 100.0, autonvals::defaultMoveTilesErrorRange, 1.5);
        turnToAngle(0.0);
        driveAndTurnDistanceTiles(0.1, 0.0, 40.0, 100.0, autonvals::defaultMoveTilesErrorRange, 1.5);
        turnToAngleVelocity(-65.0, 70.0, -halfRobotLengthIn * 1.6);
        ...
        // Intake up
        turnToAngleVelocity(110.0, 70.0);
        driveAndTurnDistanceTiles(1.4, 110.0, 60.0, 100.0, autonvals::defaultMoveTilesErrorRange, 1.5);
        ...
        setIntakeState(0);
        setGoalClampState(0);
        driveAndTurnDistanceTiles(2.0, 240.0, 30.0, 100.0, autonvals::defaultMoveTilesErrorRange, 2.0);
        //*/
    }
